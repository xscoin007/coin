...
uint256 hashGenesisBlock("0x98d3ef3d7b57469d2078d4be35f2db9151cdb27e6b8171a4fd2399159c7a1394");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // xscoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "xscoin Signed Message:\n";
...
{
    // xscoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
static const int64 nTargetTimespan = 302400; // xscoin: 3.5 days
static const int64 nTargetSpacing = 150; // xscoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // xscoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // xscoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // xscoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x4c2bc5928294f6ac282640b9b1eb1f8ea8045a45d029b95174370ff921c37ce0");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("96545d2dfa11af8b3a693b5902f124c6c854e5a096c9bab751c7484aae86a375fdaa104cd5a649ae583a8caba53946cc80b2d1a3a1b5953b7cd7875f6703637673") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1525344832;
        block.nBits    = 504365644;
        block.nNonce   = 1508186995;

        if (fTestNet)
        {
            block.nTime    = 1525344832;
            block.nNonce   = 228229979;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x1719ec72ea257c062daa61f390a5d74f0b45fb53df8845a132d19b28c0afe505"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // xscoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("xscoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("xscoinMiner : ProcessBlock, block not accepted");
    }
